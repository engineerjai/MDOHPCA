...
def calculate(aerodynamic_outputs, 
    ...
    CL_alpha_dot = CL_alpha_dot_calculator(aerodynamic_outputs, SLF_output_data, cruise_altitude)
...
def CL_alpha_dot_calculator(aerodynamic_outputs, SLF_output_data, cruise_altitude=18288):
